...
GRANT USAGE ON SCHEMA clients TO mirama_user;
GRANT USAGE ON SCHEMA workspace TO mirama_user;

GRANT CREATE ON SCHEMA identity TO mirama_user;
GRANT CREATE ON SCHEMA projects TO mirama_user;
GRANT CREATE ON SCHEMA clients TO mirama_user;
GRANT CREATE ON SCHEMA workspace TO mirama_user;
...
GRANT INSERT, SELECT, UPDATE, DELETE ON ALL TABLES IN SCHEMA clients TO mirama_user;
GRANT INSERT, SELECT, UPDATE, DELETE ON ALL TABLES IN SCHEMA workspace TO mirama_user;
