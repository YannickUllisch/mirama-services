    ...
    public partial class InitMessaging : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_projects_OutboxMessages_Claimable",
                schema: "projects",
                table: "OutboxMessages",
                columns: new[] { "AvailableAtUtc", "LockedUntilUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_projects_InboxDeadLetters_OrganizationId",
                schema: "projects",
                table: "InboxDeadLetters",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_projects_InboxMessages_Claimable",
                schema: "projects",
                table: "InboxMessages",
                columns: new[] { "AvailableAtUtc", "LockedUntilUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_projects_OutboxDeadLetters_OrganizationId",
                schema: "projects",
