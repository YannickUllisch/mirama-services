...
namespace Mirama.Modules.PM.Application.Features.V1.Projects.Priorities.AddProjectPriority;

public class AddProjectPriorityController : OrganizationControllerBase
{
    [HttpPost("/projects/{projectId:guid}/priorities")]
        ...
        CancellationToken ct)
    {
        ...
        return result.Match(r => Created($"/projects/{projectId}/priorities/{r.PriorityId}", r), Problem);
    }
}
