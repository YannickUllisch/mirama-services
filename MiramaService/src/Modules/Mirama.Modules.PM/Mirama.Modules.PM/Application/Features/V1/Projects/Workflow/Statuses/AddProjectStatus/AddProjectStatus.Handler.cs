...
namespace Mirama.Modules.PM.Application.Features.V1.Projects.Workflow.Statuses.AddProjectStatus;

public class AddProjectStatusController : OrganizationControllerBase
{
    [HttpPost("projects/{projectId:guid}/workflow/statuses")]
        ...
        CancellationToken ct)
    {
        ...
        return result.Match(r => Created($"/projects/{projectId}/workflow/statuses/{r.Id}", r), Problem);
    }
}
